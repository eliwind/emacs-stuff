    ...
    (let ((bg-back   '(:background back))
      ...
      (mapcar (lambda (face) (apply 'create-face-spec face))
              `(;; basic
                ...
                (region (,@bg-base02)) ; Visual
                (secondary-selection (,@fg-base01 ,@bg-base03 ,@fmt-revbb))
                (shadow (,@fg-base01))
                ...
                (term-color-brblack (,@fg-base03))
                (term-color-brred (,@fg-orange))
                (term-color-brgreen (,@fg-base01))
                (term-color-bryellow (,@fg-base00))
                (term-color-brblue (,@fg-base0))
                (term-color-brmagenta (,@fg-violet))
                (term-color-brcyan (,@fg-base1))
                (term-color-brwhite (,@fg-base3))
                ;; company
