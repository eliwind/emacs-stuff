...
(define-key global-map (vector '(control x) '(control m) (string-to-char eol-mnemonic-unix))
  'set-buffer-eol-conversion-unix)
(define-key global-map (vector '(control x) '(control m) (string-to-char eol-mnemonic-dos))
  'set-buffer-eol-conversion-dos)
(define-key global-map (vector '(control x) '(control m) (string-to-char eol-mnemonic-mac))
  'set-buffer-eol-conversion-mac)
